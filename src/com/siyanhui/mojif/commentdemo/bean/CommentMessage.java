package com.siyanhui.mojif.commentdemo.bean;
...
public class CommentMessage {
    ...
    public CommentMessage(String msgId,String userName,boolean isMixedMessage,String messageString,String mixedCommentMessage,Date time){
    	super();
    	this.msgId = msgId;

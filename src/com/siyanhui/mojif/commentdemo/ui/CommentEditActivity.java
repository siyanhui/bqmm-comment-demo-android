...
public class CommentEditActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.siyanhui.mojif.commentdemo.R.layout.bqmm_comment_edit);
		initView();
	}

	private void initView() {
		mEditView = (BQMMEditView) findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_editview);
		mKeyboard = (BQMMKeyboard) findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_keyboard);
		mSendButton = (BQMMSendButton) findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_sendbutton);
		mSendButton.setVisibility(View.VISIBLE);
		mBackButton = (TextView) findViewById(com.siyanhui.mojif.commentdemo.R.id.titleLayout_back);
		...
		mOpenBox = (CheckBox) findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_checkbox);
		mOpenArea = (RelativeLayout) findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_checkbox_area);
		mRootView = findViewById(com.siyanhui.mojif.commentdemo.R.id.comment_rootview);
	...
	private void initBQMMSDK() {
		...
		bqmmsdk.setMode(BQMMConstant.BQMM_CM);
		bqmmsdk.load();
	...
	private static class BqmmSendMessageListener implements IBqmmSendMessageListener {
		...
		public void onSendMixedMessage(List<Object> messageContent, boolean isMixedMessage) {
			...
			if (activity != null) {
				...
				intent.putExtra("mixedCommentMessageData", BQMMMessageHelper
						.getMixedMessageData(messageContent).toString());
				intent.putExtra("isMixedMessage", isMixedMessage);
				intent.putExtra("mixedCommentMessageString", BQMMMessageHelper
						.getMixedMessageString(messageContent).toString());
